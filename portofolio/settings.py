...
# Di laptop, variabel lingkungan dibaca dari berkas .env (tidak ikut di-commit).
# Di PWS, variabel yang sama diatur lewat Project Environment Variables.
...
SECRET_KEY = 'django-insecure-*ggsu7g_-$hz^o&@a-x=nd#!088!i1m#b(5_8n*o3sf42$iui+'
...
# PWS memakai PostgreSQL supaya data tidak hilang setiap kali deploy. Berkas SQLite
# di server PWS dibuat ulang dari nol pada setiap push, jadi hanya dipakai di laptop.
if PRODUCTION:
    DATABASES = {
        "default": {
